<div>
    ...
    <form class="p-5 py-2 w-flex w-auto" wire:submit.prevent="create">
        ...
        <div x-data="{ open: @entangle('address.default') }" class="flex gap-1 border-orange-500">
            <input wire:model.defer="address.default" x-model="open" value="checkbox" type="checkbox" id="scales" name="scales" class="w-5 h-5">
